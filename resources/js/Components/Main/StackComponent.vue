<template>
    ...
    <div id="stack" class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 items-center gap-2">
            <!-- Icon Block -->
            <a class="group flex flex-col justify-center hover:bg-gray-50 rounded-xl p-4 md:p-7" href="https://laravel.com" target="_blank" rel="noopener noreferrer">
                ...
                <div class="mt-5">
                    <h3 class="group-hover:text-gray-600 text-lg font-semibold text-gray-800">Laravel</h3>
                    <p class="mt-1 text-gray-600">Modern PHP framework for web artisans.</p>
                </div>
            </a>
            <!-- End Icon Block -->

            <!-- Icon Block -->
            <a class="group flex flex-col justify-center hover:bg-gray-50 rounded-xl p-4 md:p-7" href="https://vuejs.org" target="_blank" rel="noopener noreferrer">
                <div class="flex justify-center items-center w-12 h-12 bg">
                ...
                <div class="mt-5">
                    <h3 class="group-hover:text-gray-600 text-lg font-semibold text-gray-800">Vue</h3>
                    <p class="mt-1 text-gray-600">Fast, progressive frontend framework.</p>
                </div>
            </a>
            <!-- End Icon Block -->

            <!-- Icon Block -->
            <a class="group flex flex-col justify-center hover:bg-gray-50 rounded-xl p-4 md:p-7" href="https://www.postgresql.org/" target="_blank" rel="noopener noreferrer">
                <div class="flex justify-center items-center w-12 h-12 bg">
                ...
                <div class="mt-5">
                    <h3 class="group-hover:text-gray-600 text-lg font-semibold text-gray-800 ">PostgreSQL</h3>
                    <p class="mt-1 text-gray-600">The World's Most Advanced Open Source Relational Database.</p>
                </div>
            </a>
            <!-- End Icon Block -->

            <!-- Icon Block -->
            <a class="group flex flex-col justify-center hover:bg-gray-50 rounded-xl p-4 md:p-7" href="https://www.docker.com/" target="_blank" rel="noopener noreferrer">
                <div class="flex justify-center items-center w-12 h-12 bg">
                ...
                <div class="mt-5">
                    <h3 class="group-hover:text-gray-600 text-lg font-semibold text-gray-80">Docker</h3>
                    <p class="mt-1 text-gray-600">Software platform for build, test and deploy web applications.</p>
                </div>
            </a>
            <!-- End Icon Block -->
        </div>
